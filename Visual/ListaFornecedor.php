...
<!--  <button class="botoesCabecalho" onclick="window.location.href='./Visual/ListaUsuario.php'">ListagemUsuario</button>
  ...
  -->
    ...
    <div class="divTitulo">
        ...
        <h1 class="titulo">Aqui estão seus fornecedores cadastrados</h1>
    ...
    <div class="divTable"> 
        ...
        <?php
            ...
            $lista = $daoFornecedor->listaTodos($user);
            $aux = 0;
    ...
    <script>
        window.addEventListener('load', function()
        {
            ...
            {
                window.location.href = 'http://localhost/Web1%20atv%20all/Visual/FormCadastroFornecedor.php';
            });
        });
    </script>
